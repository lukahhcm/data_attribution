...
Equation~\eqref{eq:bilevel-selection} is our optimization target, not a claim
...
\eqref{eq:capped-simplex} as an explicit algorithmic adaptation whose behavior
