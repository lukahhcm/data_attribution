...
The three attribution--approximation correspondences in
Section~\ref{sec:attribution-correspondence} are the paper's first theoretical
insight, while the RQs above study their shared one-step limitation through the
VF--RHO branch. Gradient sign, unrolled-recurrence checks, inner tracking,
budget projection, and ranking agreement must pass the gates in
Section~\ref{sec:experiments} before the selection results receive a bilevel
interpretation.
