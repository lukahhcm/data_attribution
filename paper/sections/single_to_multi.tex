...
Equation~\eqref{eq:rho-vf-equivalence} is a local statement: at a fixed
...
Eq.~\eqref{eq:practical-rho}; VF-1 uses the verified two-inner direction in
Eq.~\eqref{eq:vf-score}.
